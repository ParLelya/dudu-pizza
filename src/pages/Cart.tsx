				...
				products.length
					? (
						<div className="cart">
							...
							<div className="content__items">
								{
									products.map((obj: IProduct) => <ProductInCart key={obj.id} {...obj} />)
								}
							</div>
							<div className="cart__bottom">
								<div className="cart__bottom-details">
									<span>Всего пицц: <b>{totalProductsCount} шт.</b> </span>
					...
					: (
						<div className="cart cart--empty">
							<h2>Корзина грустит, в ней пусто 😕 </h2>
							<p>
								Вы что, ещё не выбрали пиццу?<br />
								Скорее переходите на главную страницу!
							</p>
